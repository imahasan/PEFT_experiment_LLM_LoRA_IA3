#!/bin/bash
#SBATCH --job-name=ia3_ft_1gpu_3epo_final          # Job name
#SBATCH --output=IA3_finetune_%j.log               # Output log file (%j will be replaced with the job ID)
#SBATCH --error=IA3_finetune_%j.err                # Error log file (%j will be replaced with the job ID)
...
# Run the IA3 training script
python IA3_ft_script_final.py
